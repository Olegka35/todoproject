...
import todo.methods.ArticleCookie;
...
public class TaskController {
    ...
    @Autowired
    public TaskController(ArticleService articleService, OperatorService operatorService) {
    ...
    public String deleteArticle(HttpServletRequest request, @RequestBody String id) {
        articleService.delete(Integer.parseInt(id.split("=")[1]));
